...
public class Main_s1_3_niv2_ex2_montseliz {
	...
	public static void main(String[] args) {
		...
		System.out.println("\nTransformem el HashSet en un TreeSet ordenat per nom i value:\n");
		
		TreeSet<Restaurant> treeSetRestaurants = new TreeSet<Restaurant>(setRestaurants);
		
		Iterator<Restaurant> it3 = treeSetRestaurants.iterator();
		while (it3.hasNext()) {
